...
public class RoundScoreTest {
    ...
    public void testNoChange(){
        ...
        assertEquals(roundScore.getScoreString(), "0");
    }

    @Test
    public void testIncrease(){
        roundScore = new RoundScore(500);
        assertEquals(roundScore.getScoreString(), "<font color='#00FF00'>+500</font>");
    }

    @Test
    public void testDecrease(){
        roundScore = new RoundScore(-500);
        assertEquals(roundScore.getScoreString(), "<font color='#FF0000'>-500</font>");
    }
}
